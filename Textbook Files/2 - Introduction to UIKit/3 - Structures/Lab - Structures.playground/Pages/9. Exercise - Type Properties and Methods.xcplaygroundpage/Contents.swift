...
struct User {
    ...
    static var currentUser: User = User(userName: "", email: "", age: 0)
    
    static func loginUser(user: User) {
        currentUser = user
        print("Welcome \(user.userName), you have logged on.")
    }
}

var me = User(userName: "andy.v", email: "me@gmail.com", age: 24)
User.loginUser(user: me)
 ...
 */
var bryanBooks = User(userName: "bryan.books", email: "bb@gmail.com", age: 29)
User.loginUser(user: bryanBooks)
print(User.currentUser)
/*:
