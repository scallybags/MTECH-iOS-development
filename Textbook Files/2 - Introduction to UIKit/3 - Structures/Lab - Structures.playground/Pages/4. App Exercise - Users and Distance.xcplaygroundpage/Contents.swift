...
var andrew = User(name: "Andrew", age: 24, height: 65, weight: 120, activityLevel: 7)
print("User: \(andrew.name), is \(andrew.age). He is \(andrew.height) inches tall, weighing in at \(andrew.weight) with an activity level of \(andrew.activityLevel)/10.")
/*:
