...
var myRect = Rectangle(width: 10, height: 12)
print(myRect.area)
/*:
...
struct Height {
    var heightInInches: Double {
        didSet {
            var inchToCentimeters = heightInInches * 2.54
            if heightInCentimeters != inchToCentimeters {
                heightInCentimeters = inchToCentimeters
            }
        }
    }
    ...
    var heightInCentimeters: Double {
        didSet {
            var centimetersToInch = heightInCentimeters / 2.54
            if heightInInches != centimetersToInch {
                heightInInches = centimetersToInch
            }
        }
    }
}
