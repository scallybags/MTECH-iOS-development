...
func progressUpdate() {
    switch steps {
    case 0...1000: print("You're off to a good start.")
    case 0...5000: print("You're almost halfway there!")
    case 5001...9000: print("You're over halfway there!")
    case 0...9999: print("You're almost there!")
    default: ("You beat your goal!")
    }
}
progressUpdate()
/*:
