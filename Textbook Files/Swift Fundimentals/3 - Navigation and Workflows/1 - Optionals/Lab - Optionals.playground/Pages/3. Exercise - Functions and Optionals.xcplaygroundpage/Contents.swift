...
func checkAge(ageAsString: String) -> Int? {
    guard let age = Int(ageAsString) else {
...
func checkStockPrice(item: String) -> Double? {
...
let result: Double? = checkStockPrice(item: "Apple")
print(result)
/*:
