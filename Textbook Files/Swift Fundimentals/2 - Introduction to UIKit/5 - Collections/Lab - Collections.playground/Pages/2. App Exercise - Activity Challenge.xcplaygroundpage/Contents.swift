 ...
 */
var walkingChallenges: [String] = ["Walk 10,000 steps", "Walk a 1 mile in elevation"]
var runningChallenges: [String] = ["Run 1 mile a day", "Run 1 mile in under 10 minutes"]
...
if committedChallenges.isEmpty {
    ...
    print("The challenge you have chozen is \(committedChallenges[0]).")
} else {
