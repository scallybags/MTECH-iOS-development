...
func pacing(currentDis: Double, totalDis: Double, currentTime: Double, goalTime: Double) {
    if currentDis / currentTime >= totalDis / goalTime {
        print("Keep it up")
    } else {
        print("You've got to push it just a bit harder.")
    }
}
pacing(currentDis: 100, totalDis: 1000, currentTime: 10, goalTime: 100)
/*:
