...
var favBook = Book(title: "Dune", author: "Frank Herbert", pages: 1000, price: 18.99)
/*:
...
var laptop2 = Laptop(screenSize: 25, repairCount: 39, yearPurchased: 2993)
/*:
...
let someHeight = Height(heightInInches: 65)
...
let myHeight = Height(heightInInches: 45)
