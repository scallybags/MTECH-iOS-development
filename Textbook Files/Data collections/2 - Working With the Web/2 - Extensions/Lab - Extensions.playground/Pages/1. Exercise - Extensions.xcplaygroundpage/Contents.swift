...
//extension Character {
//    func isVowel() -> Bool {
//        self == Character("a") || Character("e") || Character("i") || Character("o") || Character("u")
//    }
//}
...
extension Rect {
    func halved() -> Rect {
        Rect(length: (self.length / 2) , width: (self.width / 2))
    }
 ...
 */
var myRectangle = Rect(length: 20.0, width: 10.0)
var mySmallRect = myRectangle.halved()
myRectangle.half()
/*:
