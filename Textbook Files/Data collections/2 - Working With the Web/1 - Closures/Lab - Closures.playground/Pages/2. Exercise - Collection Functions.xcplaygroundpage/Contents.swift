...
let names = ["Andrew", "Quen", "Aly", "Eric", "Emily", "Sarah", "Kit", "Peter"]
let sortedColl1 = names.sorted(by: forwards(name1:name2:))
print(sortedColl1)
...
let sortedColl2 = names.sorted(by: { (name1: String, name2: String) -> Bool in
    return name1 < name2
})
print(sortedColl2)
...
let sortedColl3 = names.sorted(by: { $0 < $1 } )
print(sortedColl3)
/*:
